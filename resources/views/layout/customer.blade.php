                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="height: 93vh; background-color:rgb(99, 177, 246)">
                    <div class="position-sticky pt-3 sidebar-sticky">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a href="{{ url('customer') }}" class="nav-link active" aria-current="page"><i class="fa fa-home"></i> Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('reservasi') }}" class="nav-link active" aria-current="page"><i class="fa fa-regular fa-splotch"></i> Reservasi</a>
                            </li>
                        </ul>
                    </div>
                </nav>
